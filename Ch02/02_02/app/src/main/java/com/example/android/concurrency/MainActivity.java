    ...
    class MyTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            for (String value :
                ...
                // Publish the update (value) to the UI / Main Thread
                // as the task is executing
        ...
        // onProgressUpdate() runs on the Main UI Thread
        @Override
        protected void onProgressUpdate(String... values) {

            // Display the value to the TextView of the
            // Activity on the Main UI thread
            log(values[0]);
        }
    }
